 ...
 *
 * A match type reduces to one of its right-hand sides, depending on the type of its scrutinee. What that means is that
 * we are defining the types we should get for the inputs.
 */
